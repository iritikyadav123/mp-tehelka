        ...
        <div>
            ...
            <>
                <div className="snap-x mx-auto snap-mandatory h-[100rem] flex w-auto overflow-x-scroll justify-evenly gap-4 sm:gap-2 lg:ml-2 no-scrollbar mt-10">
                    <div className="snap-start bg-pink-300 w-[23rem] flex-col gap-4 flex-shrink-0 h-[30rem] flex items-center justify-center text-8xl rounded-md overflow-auto no-scrollbar">
                    ...
                    <div className="bg-green-500 snap-end  w-[23rem]  flex-shrink-0 h-[30rem] flex items-center justify-center text-8xl rounded-md">
                        <AllNews />
                    </div>
                </div>
            </>
